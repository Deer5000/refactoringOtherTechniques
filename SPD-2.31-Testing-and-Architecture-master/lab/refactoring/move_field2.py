...
engine = Engine()
tpms = { "front-right": Tpms(983408543), "front-left": Tpms(4343083),
...
# TODO: Rewrite the following after moving tpms to the 'Wheel' class.
wheels = [
            Wheel(tpms['front-right'], wheel_location = "front-right"), 
            Wheel(tpms['front-left'], wheel_location = "front-left"),
            Wheel(tpms['back-right'], wheel_location = "front-right"), 
            Wheel(tpms['back-left'], wheel_location = "back-left"), 
]
